...
class Config_MBM_EEG(Config_MAE_fMRI):
    ...
    # MAE for fMRI
        ...
        # Project setting
        self.root_path = '/mnt/nvme/node02/pranav/AE24/DreamDiffusion/dreamdiffusion/'
        self.output_path = '/mnt/nvme/node02/pranav/AE24/DreamDiffusion/dreamdiffusion/exps/'
        self.seed = 2022
        self.roi = 'VC'
        self.aug_times = 1
